...
The content in these sections is what guides the agent when it creates a
technical plan, which is then implemented. Spending time on getting the
specification right ultimately saves you time, as the resulting plan is more
likely to be correct and contain the features you actually want to build. It
also acts as living documentation for the features you are building, and lets
you collaborate with your team on the initial requirements.
...
You may wonder why the SQLite constraint is not in the technical approach. This
