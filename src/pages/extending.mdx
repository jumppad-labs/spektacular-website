...
type Store interface {
    ...
    // store. Hits are left unattributed for the caller to tag.
...
type Hit struct {
    Tier    string  `json:"tier"`    // addressing tier, stamped by the caller
    Name    string  `json:"name"`    // originating store's name, stamped by the caller
